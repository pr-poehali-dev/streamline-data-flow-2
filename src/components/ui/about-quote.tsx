        ...
        <div className="relative z-20 mx-auto max-w-5xl rounded-[40px] py-6 md:p-10 xl:py-20">
          ...
          <div className="space-y-4 md:space-y-6">
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Мы верим: хорошая идея не должна умирать из-за нехватки разработчиков или бюджета. PromptCraft рождён, чтобы сократить путь от замысла до готового продукта до минут — а не месяцев.
            </p>
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Стартап на старте, агентство в горящем дедлайне или предприниматель с идеей в голове — вы описываете, ИИ строит, вы запускаете. Это и есть новая скорость создания продуктов.
            </p>
          </div>
        </div>
      </div>
